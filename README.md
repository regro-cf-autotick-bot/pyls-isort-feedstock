...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyls-isort-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10927&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyls-isort-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyls-isort` can be installed with:

```
conda install pyls-isort
```

It is possible to list all of the versions of `pyls-isort` available on your platform with:
